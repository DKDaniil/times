        ...
        <app-container>
            <div class="main-block__wrapper">
                <div class="main-block__info">
                    ...
                    >
                    <strong><span>Time</span>Flies.</strong>
                    </h1>
                    <div
                        ref="description"
                        class="main-block__description"
                    >
                    <strong> Не тратьте своё время, ведь вы достойны лучшего, у нас выы найдетё как бюджетный вариант, так и эксклюзивные товары!
                    </strong>
                    </div>
                    <div
                        ref="button"
